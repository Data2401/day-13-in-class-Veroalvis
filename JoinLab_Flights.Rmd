...
```{r}
patient_visit <- right_join(patients, visits)

#Find all the names that have visited the hospital
patient_visit %>% 
...
patient_partial_info <- full_join(patients, visits)

# List all the visits and patient information, even if there isn't information for the patient 
patient_full_info <- full_join(patient_partial_info, doctors)
